...
void _userModelAttach(IsarCollection<dynamic> col, Id id, UserModel object) {
  object.id = id;
  object.files.attach(col, col.isar.collection<FileModel>(), r'files', id);
}
...
extension UserModelQueryLinks
    on QueryBuilder<UserModel, UserModel, QFilterCondition> {
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> files(
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> filesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> filesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'files', 0, true, 0, true);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> filesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'files', 0, false, 999999, true);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> filesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> filesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
